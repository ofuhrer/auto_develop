...
- release-local final adjudication after bounded review repair, including typed `review_finding_adjudication` records, final integration verification before classification, and repo-state compaction of accepted or deferred findings for the next planning cycle;

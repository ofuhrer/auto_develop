...
- bounded planner-output normalization with strict revalidation and validator-rerun metadata; reviewer- and supervisor-output normalization remain planned extensions on the same seam;

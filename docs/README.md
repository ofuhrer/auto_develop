...
- supervisor-owned execution-strategy selection before contract generation, including one-shot implementation for cohesive medium-sized epics and decomposition only when it adds value;
